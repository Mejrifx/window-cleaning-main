...
export const translations: Record<Language, Translations> = {
  ...
  nl: {
    ...
    residentialDesc: 'Beschikbaar in regio Zeeuws Vlaanderen & grensgemeenten in België',
    ...
    highRiseDesc: 'Voor de reiniging van uw vakantiehuis - en woning',
    ...
    featureReliableDesc: 'Traditioneel met de hand of met osmose water.',
    featureInsured: 'Dakgoot reiniging',
    featureInsuredDesc: 'Zowel leeghalen als het schoonmaken van de buitenkant.',
    featureEco: 'Zonnepaneel reiniging',
    featureEcoDesc: 'Voor een beter rendement van uw panelen.',
    featureLocal: 'Rolluik reiniging',
    featureLocalDesc: 'Zowel binnen als buiten en het laten glimmen van de rolluik bakken.',
    featureSatisfaction: 'Gevel en terrasreiniging',
    featureSatisfactionDesc: 'Met warme hoge druk en softwash ziet uw bestrating/ gevel er weer als nieuw uit.',
